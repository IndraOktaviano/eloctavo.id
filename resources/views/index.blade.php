    ...
    <div class="cavani_tm_all_wrap" data-magic-cursor="show" data-enter="fadeInUp" data-exit="">
        ...
        <div class="cavani_tm_mobile_menu">
            <div class="inner">
                <div class="wrapper">
                    <div class="avatar">
                        <div class="image" data-img-url="{{asset('assets/img/about/1.jpg')}}"></div>
                    </div>
                    <div class="menu_list">
                        <ul class="transition_link">
                            <li class="active"><a href="#home">Home</a></li>
                    ...
                    <div class="social">
                        <ul>
                            <li><a href="#"><img class="svg" src="{{asset('assets/img/svg/social/facebook.svg')}}"
                                        alt="" /></a></li>
                            <li><a href="#"><img class="svg" src="{{asset('assets/img/svg/social/twitter.svg')}}"
                                        alt="" /></a></li>
                            <li><a href="#"><img class="svg" src="{{asset('assets/img/svg/social/instagram.svg')}}"
                                        alt="" /></a></li>
                            <li><a href="#"><img class="svg" src="{{asset('assets/img/svg/social/dribbble.svg')}}"
                                        alt="" /></a></li>
                            <li><a href="#"><img class="svg" src="{{asset('assets/img/svg/social/tik-tok.svg')}}"
                                        alt="" /></a></li>
                        </ul>
                    </div>
                    <div class="copyright">
        ...
        <div class="cavani_tm_mainpart">
            <div class="author_image">
                <div class="main" data-img-url="{{asset('assets/img/about/profile.jpg')}}"></div>
            </div>
            <div class="main_content">
                ...
                <div class="cavani_tm_section animated" id="home">
                    <div class="cavani_tm_home">
                        <div class="content">
                            <h3 class="name">Indra Oktaviano</h3>
                            <span class="line"></span>
                            <h3 class="job">
                                <span class="cd-headline clip">
                                    <!-- ANIMATE TEXT VALUES: zoom, rotate-1, letters type, letters rotate-2, loading-bar, slide, clip, letters rotate-3, letters scale, push,  -->
                                    <span class="blc">Web</span>
                    ...
                    <div class="section_inner">
                        <div class="cavani_tm_about">
                            <div class="biography">
                                ...
                                <div class="wrapper">
                                    <div class="left">
                                        <p>Hello there! My name is <strong>Indra Oktaviano.</strong> I am a website developer, and I'm very passionate and dedicated to my work.</p>
                                        <p>With 3 years experience as a professional a website developer, I have
                                            acquired the skills and knowledge necessary to make your project a success.
                                        </p>
                                    </div>
                                    <div class="right">
                                        <ul>
                                            <li><span class="first">Name:</span><span class="second">Indra Oktaviano</span></li>
                                            <li><span class="first">Address:</span><span class="second" style="display: inline">Jombang, Ciputat, Tangerang Selatan</span></li>
                                            ...
                                            <li><span class="first">Mail:</span><span class="second"><a href="#">indra@eloctavo.id</a></span></li>
                                            <li><span class="first">Phone:</span><span class="second">+62 857 8260 2718</span></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="service_list">
                                        ...
                                        <div class="list">
                                            <ul>
                                                ...
                                                <li><i class="icon-right-dir"></i>Company Profile</li>
                                                <li><i class="icon-right-dir"></i>Online Shop</li>
                                                <li><i class="icon-right-dir"></i>Landing Page</li>
                                                <li><i class="icon-right-dir"></i>Community Website</li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="interests">
                                        ...
                                        <div class="list">
                                            <ul>
                                                <li><i class="icon-right-dir"></i>Full Stack Website Designer</li>
                                                <li><i class="icon-right-dir"></i>PHP Fundamental</li>
                                                <li><i class="icon-right-dir"></i>Laravel Fundamental</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="wrapper">
                                    <div class="programming">
                                        ...
                                        <div class="cavani_progress">
                                            ...
                                            <div class="progress_inner" data-value="80">
                                                <span><span class="label">PHP</span><span
                                                        class="number">80%</span></span>
                                                <div class="background">
                                                    <div class="bar">
                                                        <div class="bar_in"></div>
                                            ...
                                            <div class="progress_inner" data-value="80">
                                                <span><span class="label">Laravel</span><span
                                                        class="number">80%</span></span>
                                                <div class="background">
                                                    <div class="bar">
                                                        <div class="bar_in"></div>
                                            ...
                                            <div class="progress_inner" data-value="60">
                                                <span><span class="label">UI / UX</span><span
                                                ...
                                                <ul>
                                                    <li>
                                                        <div class="list_inner">
                                                            ...
                                                            <div class="place">
                                                                <h3>Built With Angga</h3>
                                                                <span>Full-Stack Web Designer Online Course</span>
                                                            </div>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="list_inner">
                                                            ...
                                                            <div class="place">
                                                                <h3>WebHozz</h3>
                                                                <span>Framework Laravel Course</span>
                                                            </div>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="list_inner">
                                                            ...
                                                            <div class="place">
                                                                <h3>WebHozz</h3>
                                                                <span>PHP Fundamental Course</span>
                                                            </div>
                                                        </div>
                                                    </li>
                                                    <li>
                                                ...
                                                <ul>
                                                    <li>
                                                        <div class="list_inner">
                                                            ...
                                                            <div class="place">
                                                                <h3>PT. Akusara Gautama Solution</h3>
                                                    ...
                                                    <li>
                                                        <div class="list_inner">
                                                            ...
                                                            <div class="place">
                                                                <h3>PT. Modernesia Teknologi Indonesia</h3>
                                                                <span>Web Developer</span>
                                                            </div>
                                                        </div>
                                                    </li>
                            ...
                            <div class="partners">
                                ...
                                <div class="list">
                                    <ul>
                                        <li>
                                            <div class="list_inner">
                                                <img src="{{asset('assets/img/partners/mdp.png')}}" alt="" />
                                                <a class="cavani_tm_full_link" href="https://mdpratama.co.id/" target="_blank"></a>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="list_inner">
                                                <img src="{{asset('assets/img/partners/mti.png')}}" alt="" />
                                                <a class="cavani_tm_full_link" href="https://modernesia.com/" target="_blank"></a>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
                                    ...
                                    <ul class="owl-carousel">
                                        <li>
                                            <div class="list_inner">
                                                ...
                                                <div class="details">
                                                    <div class="image">
                                                        <div class="main" data-img-url="{{asset('assets/img/testimonials/1.jpg')}}">
                                                        </div>
                                                    </div>
                                                    <div class="info">
                                        ...
                                        <li>
                                            <div class="list_inner">
                                                ...
                                                <div class="details">
                                                    <div class="image">
                                                        <div class="main" data-img-url="{{asset('assets/img/testimonials/2.jpg')}}">
                                                        </div>
                                                    </div>
                                                    <div class="info">
                                        ...
                                        <li>
                                            <div class="list_inner">
                                                ...
                                                <div class="details">
                                                    <div class="image">
                                                        <div class="main" data-img-url="{{asset('assets/img/testimonials/3.jpg')}}">
                                                        </div>
                                                    </div>
                                                    <div class="info">
                                    ...
                                    <li class="image">
                                        <div class="list_inner">
                                            <div class="image">
                                                ...
                                                <a class="cavani_tm_full_link zoom" href="{{asset('assets/img/portfolio/4.jpg')}}"></a>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="image">
                                        <div class="list_inner">
                                            <div class="image">
                                                ...
                                                <a class="cavani_tm_full_link zoom" href="{{asset('assets/img/portfolio/5.jpg')}}"></a>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="detail">
                                                            ...
                                                            <ul>
                                                                ...
                                                                <li>
                                                                    ...
                                                                    <ul class="share">
                                                                        ...
                                                                        <li>
                                                                            <a href="#">
                                                                                <img class="svg" src="{{asset('assets/img/svg/social/instagram.svg')}}" alt="" />
                                                                            </a>
                                                                        </li>
                                                                    </ul>
                                                                </li>
                                                    ...
                                                    <div class="additional_images">
                                                        <ul>
                                                            <li>
                                                                <div class="list_inner">
                                                                    <div class="my_image">
                                                                        <img src="img/thumbs/4-2.jpg"
                                                                            alt="" />
                                                                        <div class="main"
                                                                            data-img-url="{{asset('assets/img/portfolio/1.jpg')}}"></div>
                                                                    </div>
                                                                </div>
                                                            </li>
                                                            <li>
                                                                <div class="list_inner">
                                                                    <div class="my_image">
                                                                        <img src="img/thumbs/4-2.jpg"
                                                                            alt="" />
                                                                        <div class="main"
                                                                            data-img-url="{{asset('assets/img/portfolio/2.jpg')}}"></div>
                                                                    </div>
                                                                </div>
                                                            </li>
                                                            <li>
                                                                <div class="list_inner">
                                                                    <div class="my_image">
                                                                        <img src="img/thumbs/4-2.jpg"
                                                                            alt="" />
                                                                        <div class="main"
                                                                            data-img-url="{{asset('assets/img/portfolio/3.jpg')}}"></div>
                                                                    </div>
                                                                </div>
                                                            </li>
                                                        </ul>
                            ...
                            <div class="news_list">
                                <ul>
                                    <li>
                                        <div class="list_inner">
                                            <div class="image">
                                                <img src="{{asset('assets/img/thumbs/4-3.jpg')}}" alt="" />
                                            ...
                                            <div class="details">
                                                <div class="metabox">
                                                    ...
                                                    <div class="title">
                                                        <h3><a href="#">Building brands through customer
                                                                service</a></h3>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <li>
                                        <div class="list_inner">
                                            <div class="image">
                                                <img src="{{asset('assets/img/thumbs/4-3.jpg')}}" alt="" />
                                                <div class="main" data-img-url="{{asset('assets/img/news/4.jpg')}}"></div>
                                                <a class="cavani_tm_full_link" href="#"></a>
                                            </div>
                                            <div class="details">
                                                <div class="metabox">
                                    ...
                                    <li>
                                        <div class="list_inner">
                                            <div class="image">
                                                <img src="{{asset('assets/img/thumbs/4-3.jpg')}}" alt="" />
                                                <div class="main" data-img-url="{{asset('assets/img/news/5.jpg')}}"></div>
                                                <a class="cavani_tm_full_link" href="#"></a>
                                            </div>
                                            <div class="details">
                                                <div class="metabox">
                                    ...
                                    <li>
                                        <div class="list_inner">
                                            <div class="image">
                                                <img src="{{asset('assets/img/thumbs/4-3.jpg')}}" alt="" />
                                                <div class="main" data-img-url="{{asset('assets/img/news/6.jpg')}}"></div>
                                                <a class="cavani_tm_full_link" href="#"></a>
                                            </div>
                                            <div class="details">
                                                <div class="metabox">
                    ...
                    <div class="section_inner">
                        <div class="cavani_tm_contact">
                                ...
                                <ul>
                                    <li>
                                        <div class="list_inner">
                                            ...
                                            <span>Jombang, Ciputat, Tangerang Selatan</span>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="list_inner">
                                            <i class="icon-mail-3"></i>
                                            <span><a href="#">indra@eloctavo.id</a></span>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="list_inner">
                                            <i class="icon-mobile"></i>
                                            <span>+62 8260 2718</span>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                            <div class="form">
                                ...
                                <div class="right">
                                    <div class="map_wrap">
                                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15862.998611313558!2d106.69584616649612!3d-6.296593548726465!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69fab6bf58af37%3A0xbcdb8cf2b6fd73f4!2sJombang%2C%20Kec.%20Ciputat%2C%20Kota%20Tangerang%20Selatan%2C%20Banten!5e0!3m2!1sid!2sid!4v1672599969296!5m2!1sid!2sid" width="600" height="350" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="cavani_tm_footer">
            ...
            <div class="social">
                <ul>
                    ...
                    <li>
                        <a href="#">
                            <img class="svg" src="{{asset('assets/img/svg/social/tik-tok.svg')}}" alt="" />
                        </a>
                    </li>
                </ul>
            </div>
